...
subgraph INGEST["Ingest"]
  ...
  subgraph RECEIPT_FLOW["Kvittoflöde (WF1_RECEIPT)"]
    ...
    r_other_start["r_other startad"]
    r_other["Annat: arkivera / manuell kontroll"]
    r_other_end["r_other avslutad"]
  end
  ...
  subgraph MATCHING["Automatchning (AI5)"]
    ...
    %% beslut betraktas ej som process, ingen status
    m_found{"Match hittad?"}
  ...
  fc_parse_start --> fc_parse --> fc_parse_end --> fc_ready_start
  ...
  detect_type -->|faktura ej FC| r_other_start
  detect_type -->|annat| r_other_start
  r_other_start --> r_other --> r_other_end
...
flowchart TD
  ...
  %% ---------- Klassapplicering ----------
  class src_portal_start,src_ftp_start,src_fc_start,ingest_store_start,ingest_wf1_start,fc_create_start,fc_ocr_start,fc_parse_start,fc_ready_start,detect_type_start,r_ocr_start,r_ai3_start,r_ai4_start,r_persist_start,r_queue_match_start,r_other_start,ai5_start,m_link_start,m_unmatched_start,finalize_ok_start,finalize_fail_start start;
  class src_portal_end,src_ftp_end,src_fc_end,ingest_store_end,ingest_wf1_end,fc_create_end,fc_ocr_end,fc_parse_end,fc_ready_end,detect_type_end,r_ocr_end,r_ai3_end,r_ai4_end,r_persist_end,r_queue_match_end,r_other_end,ai5_end,m_link_end,m_unmatched_end,finalize_ok_end,finalize_fail_end,KLAR done;
```
