...
# XXXX — JSON Conventions (Template)

- Encoding: UTF-8; `application/json; charset=utf-8`
- Property case: **camelCase** in JSON; **snake_case** in DB
- Dates: RFC3339 UTC (e.g., `2025-09-03T11:22:33Z`)
- Money: strings (or integer cents) — avoid float
- IDs: UUID v7 preferred (lexicographically sortable)
- Nullability: explicit `null` when applicable
